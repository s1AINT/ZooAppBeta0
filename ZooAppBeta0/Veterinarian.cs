...
namespace ZooAppBeta0
{
    class Veterinarian
    {
        ...
        public Veterinarian(string name, string birthday, string phone_number, int id_of_marital_status, int animalF, int animalS, int animalT)
        {
            this.name = name;
        ...
        public Veterinarian(string name, string birthday, string phone_number, int id_of_marital_status)
        {
            this.name = name;
            this.birthday = birthday;
            this.phone_number = phone_number;
